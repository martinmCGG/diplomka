...
docker exec -it rotnet_torch sh -c "CUDA_VISIBLE_DEVICES=1 && python train_rotationnet.py --case 1 --pretrained -a alexnet -b 240 --lr 0.01 --epochs 1500 /data/rotnet| tee logs/log.txt"
