...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='modelnet', help='modelnet / shrec')
        self.parser.add_argument('--data', default='/data/converted', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--log_dir', type=str, default='logs', help='models are saved here')

        self.parser.add_argument('--batch_size', type=int, default=8, help='input batch size')
        self.parser.add_argument('--input_pc_num', type=int, default=2048, help='# of input points')
        self.parser.add_argument('--surface_normal', type=bool, default=True, help='use surface normal in the pc input')
        self.parser.add_argument('--nThreads', default=8, type=int, help='# threads for loading data')

        self.parser.add_argument('--rot_horizontal', type=bool, default=True, help='use surface normal in the pc input')        
        self.parser.add_argument('--rot_perturbation', type=bool, default=True, help='use surface normal in the pc input')
        self.parser.add_argument('--translation_perturbation', type=bool, default=True, help='use surface normal in the pc input')
    ...
    def parse(self):
        ...
        # save to the disk
        expr_dir =  os.path.join(self.opt.log_dir, self.opt.name)
