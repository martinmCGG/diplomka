...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/data/converted', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./logs', help='models are saved here')
