...
class SVCNN(Model):
    ...
    def __init__(self, config, pretraining=True):
        super(SVCNN, self).__init__(config.name)
...
class MVCNN(Model):
    ...
    def __init__(self, model, config, cnn_name='vgg11'):
        super(MVCNN, self).__init__(config.name)
