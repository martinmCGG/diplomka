...
docker exec -it mvcnn2 sh -c "export CUDA_VISIBLE_DEVICES=1 && python train_mvcnn.py -name mvcnn -num_models 1000 -weight_decay 0.001 -num_views 12 -cnn_name vgg11"
