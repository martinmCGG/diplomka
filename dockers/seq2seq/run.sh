...
docker exec -id seq2seq sh -c "python run.py --train --data /data/converted --weights 20"
#docker exec -it seq2seq sh -c "python run.py --data /data/converted --weights 10"