...
\node[layer={300pt}{30pt}] at (0,0) (layer1) {Voxel Grid Input \\ $32\times32\times32$};

\node[layer={300pt}{30pt}, below = of layer1] (layer2) {3D convolution \\ $14\times14\times14$};

\path [line width=1.4pt](layer1) edge (layer2);

\node[layer={300pt}{30pt}, below = of layer2] (layer3) {3D convolution + MaxPooling\\ $6\times6\times6$};

\path [line width=1.4pt](layer2) edge (layer3);

\node[layer={300pt}{30pt}, below = of layer3] (layer4) {Flatten + Dense \\ 128};

\path [line width=1.4pt](layer3) edge (layer4);

\node[layer={300pt}{30pt}, below = of layer4] (layer5) {Dense \\ Number of categories};
